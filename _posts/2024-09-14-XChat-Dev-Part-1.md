...
მთელი იდეა იმაში მდგომარეობს, იქნება სერვერი, რომელიც მოისმენს `8080/tcp` პორტზე შემომავალ კავშირს და შემდეგ თითოეულ კლიენტს მოემსახურება როგორც წინასწარ გაწერილ `client` კლასს.
