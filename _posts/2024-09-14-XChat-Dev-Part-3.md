...
> **📝 საინტერესო ფაქტი:**  
> `for` ციკლით შესაძლებელია მასივში, ვექტორში, სიაში არსებული ნივთების გადამოწმება. ანუ, შესაძლებელია თითოეული ნივთის სათითაოდ შემოწმება. მაგალითად, პითონს აქვს ასეთი ხერხი: `for client in clients:` და ამის შემდეგ `client` ხდება ობიექტი, რომელზე მუშაობაც შეგვიძლია. ეს მაგალითი ამ სერიის პირველ პოსტშია მოყვანილი, სადაც ჩემი ძველი რეპოზიტორიიდან წამოღებული პითონში დაწერილი პროექტი განვიხილე.
